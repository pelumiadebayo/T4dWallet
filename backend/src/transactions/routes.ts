...
router.get("/", authorizeUser, getAllTransactionsByUserController as any);
router.get("/search", validateBody(SearchTransactionDto), authorizeUser, searchTransactionsController as any);
router.get("/filter", validateBody(FilterByDateDto), authorizeUser, getTransactionByDate as any);
